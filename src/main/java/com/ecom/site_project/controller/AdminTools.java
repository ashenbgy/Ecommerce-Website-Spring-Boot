...
import com.ecom.site_project.service.impl.*;
...
import com.ecom.site_project.service.VendorService;
...
public class AdminTools {
    ...
    */
    ...
    public String listUsersByPage(@PathVariable(name = "pageNum") int pageNum, Model model) {
        ...
        long startCount = (pageNum - 1) * UserServiceImpl.USER_PER_PAGE + 1;
    ...
    public String listVendorsByPage(@PathVariable(name = "pageNum") int pageNum, Model model) {
        ...
        long startCount = (pageNum - 1) * VendorServiceImpl.VENDORS_PER_PAGE + 1;
        long endCount = startCount + VendorServiceImpl.VENDORS_PER_PAGE - 1;
    ...
    public String listOrdersByPage(@PathVariable(name = "pageNum") int pageNum, Model model) {
        ...
        long startCount = (pageNum - 1) * OrdersServiceImpl.ORDERS_PER_PAGE + 1;
        long endCount = startCount + OrdersServiceImpl.ORDERS_PER_PAGE - 1;
    ...
    public String listCategoriesByPage(@PathVariable(name = "pageNum") int pageNum, Model model) {
        CategoryPageInfoServiceImpl pageInfo = new CategoryPageInfoServiceImpl();
        List<Category> categoryList = categoryService.listByPage(pageInfo, pageNum);

        long startCount = (pageNum - 1) * CategoryServiceImpl.TOP_CATEGORIES_PER_PAGE + 1;
        long endCount = startCount + CategoryServiceImpl.TOP_CATEGORIES_PER_PAGE - 1;
    ...
    public String listProductsByPage(@PathVariable(name = "pageNum") int pageNum, Model model,
        ...
        long startCount = (pageNum - 1) * ProductServiceImpl.PRODUCTS_PER_ADMIN_PAGE + 1;
        long endCount = startCount + ProductServiceImpl.PRODUCTS_PER_ADMIN_PAGE - 1;
