...
import com.ecom.site_project.service.OrderBasketService;
...
public class ShoppingCartRestController {
    ...
    public String addProductToBasket(@PathVariable("pid") Integer productId,
        ...
        if (user == null) return "You must login to add this product to your shopping cart!";

        Integer addedQuantity = orderBasketService.addProduct(productId, quantity, user);

        return addedQuantity > 1 ? addedQuantity + " items of this product were added to your shopping cart."
                : addedQuantity + " item of this product was added to your shopping cart.";
    }
